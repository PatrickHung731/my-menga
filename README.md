...
**有聲漫畫影片**：按 `[v]` 選一話 → 產出 MP4：乾淨畫格（無對話框）+ 配音**唸整篇小說原文** + 燒進字幕。
所有畫格自動平均分配到旁白時間軸。可選**配音聲音**（先去 `output\_voice_samples\` 試聽 7 種：曉曉/曉伊/雲希/雲健/雲揚/台灣男女）、可選**彩色或黑白**、可先試做前幾句。
影片在 `output\<話>\<話>_narrated.mp4`。（配音用微軟 Edge-TTS，免費但**需連網**。）
